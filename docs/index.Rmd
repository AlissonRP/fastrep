...
This is the primary function of [mypdf1](https://github.com/AlissonRP/mypdf1), with her you can make tables in `HTML` or `LaTeX` format, the main idea is to provide minimal parameters to create their own table, so you just need to provide a `data.frame`.
